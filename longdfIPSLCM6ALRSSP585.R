...
nc <- open.nc(
  "/mainfs/lyceum/ng6g22/WOA_project/data_input/CMIP6_raw/tos_IPSL-CM6A-LR_ssp585.nc"
)

# Read variables
lat <- var.get.nc(nc, "nav_lat")
lon <- var.get.nc(nc, "nav_lon")
...
saveRDS(
sst_long,
  "/mainfs/lyceum/ng6g22/WOA_project/tos_IPSL-CM6A-LR_ssp585.rds")
